...
export default function AdminCitizenDetailPage() {
  const { id } = useParams()
          ...
          <CardHeader className="pb-4">
            <div className="flex items-center space-x-4">
              <Avatar className="h-12 w-12">
                <AvatarFallback>
                  {citizen.FirstName ? getInitials(`${citizen.FirstName} ${citizen.Surname}`) : "C"}
                </AvatarFallback>
              </Avatar>
              <div>
                <CardTitle>
                  {citizen.FirstName && citizen.Surname ? `${citizen.FirstName} ${citizen.Surname}` : citizen.UserName}
                </CardTitle>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="flex items-center space-x-2">
                      ...
                      <span>{citizen.Address || "Not provided"}</span>
                    </div>
                    <div className="flex items-center space-x-2">
