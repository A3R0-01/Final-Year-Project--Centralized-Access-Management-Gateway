...
export default function AdminEditDepartmentPage() {
  ...
  // Initialize form with all required fields based on the API response structure
  ...
  const fetchDepartmentDetails = async () => {
    ...
    try {
      ...
      // Initialize form with department data fields
      setFormData({
        Title: data.Title || "",
        Email: data.Email || "",
            ...
            <form onSubmit={handleSubmit}>
              ...
              <CardFooter className="flex justify-between">
                <Button type="button" variant="outline" asChild>
                  <Link href={`/admin/departments/${departmentId}`}>Cancel</Link>
                </Button>
